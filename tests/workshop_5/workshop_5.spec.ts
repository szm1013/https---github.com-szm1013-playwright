...
test.skip('Open new window and navigate back', async ({context,page}) => {
    await page.goto('file:///D:/Playwright/tests/workshop_5/index.html');
...
test.skip('Add Cookie', async ({page}) => {
    await page.goto('file:///D:/Playwright/e2e/workshop_5/index.html');
    await page.click('#setCookie');
    const cookies = await page.context().cookies('file:///D:/Playwright/tests/workshop_5/index.html');
...
test.skip('delete cookie', async ({page}) => {
    ...
    const deletedCookies = await page.context().cookies('file:///D:/Playwright/tests/workshop_5/index.html');
